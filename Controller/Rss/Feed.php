...
class Feed extends \Magento\Framework\App\Action\Action{
	...
	private function generateRssFeed($limit = 50){
		...
		$rss = '<?xml version="1.0" encoding="utf-8"?><rss xmlns:smly="https://sendsmaily.net/schema/editor/rss.xsd" version="2.0"><channel><title>'.$this->helperData->getConfigValue('general/store_information/name').'</title><link>'.$baseUrl.'</link><description>Product Feed</description><lastBuildDate>'.date("D, d M Y H:i:s").'</lastBuildDate>
			';
		$rss .= implode(' ',$items);
